    ...
    <div class="form-content">
        <form method="POST" action="" class="needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="profile-upload-container mb-3">
                <img id="profilePreview" class="profile-preview" src="../img/user-rounded-svgrepo-com.jpg"
                     alt="Profile Preview">
            ...
            <div class="form-row">
                <div class="form-floating">
                    <input name="first_name" type="text" class="form-control" id="floatingFirstName" placeholder="John"
                           required>
                    <label for="floatingFirstName">First Name</label>
                </div>
                <div class="form-floating">
                    <input name="last_name" type="text" class="form-control" id="floatingLastName" placeholder="Doe"
                           required>
            ...
            <div class="form-row">
                ...
                <div class="form-floating">
                    <input name="phone" type="tel" class="form-control" id="floatingPhone" placeholder="Phone Number"
                           required>
