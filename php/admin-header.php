            ...
            <nav class="d-none d-lg-flex flex-grow-1 justify-content-center">
                <ul class="nav">
                    <li><a href="./admin-dashboard.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-dashboard.php'); ?>">Dashboard</a></li>
                    <li><a href="./admin-outage.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-outage.php'); ?>">Outage</a></li>
                    <li><a href="./admin-IoT-control.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-IoT-control.php'); ?>">IoT</a></li>
                    <li><a href="./admin-notification.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-notification.php'); ?>">Notification</a>
                    </li>
                    <li><a href="./admin-login-seasion.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-login-seasion.php'); ?>">Seasion</a></li>
                    <li><a href="./admin-user-control.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-user-control.php'); ?>">Client</a></li>
                    <li><a href="./admin-feedback.php"
                           class="nav-link px-3 <?php echo isActiveLink('admin-feedback.php'); ?>">Feedback</a></li>
                </ul>
            </nav>
